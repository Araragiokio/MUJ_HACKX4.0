  ...
  return (
    ...
    >
      <div 
        ...
        className={`bg-white w-full ${maxWidth} rounded-2xl shadow-xl border border-slate-200/90 overflow-hidden transform transition-all animate-in zoom-in-95 duration-200`}
      >
        <div className="flex items-center justify-between px-6 py-4.5 border-b border-slate-100 bg-slate-50/70">
          <div>
            <h3 className="text-base sm:text-lg font-bold text-slate-950 tracking-tight">{title}</h3>
